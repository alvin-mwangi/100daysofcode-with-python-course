...
def combine_state_names_and_abbreviations(us_state_abbrev=us_state_abbrev,
    ...
    first10abbrs = sorted(us_state_abbrev.values())[:10]
    """
    print(first10abbrs)
    print(type(first10abbrs))
    """
    
    last10states = sorted(states)[-10:]
    """
    print(last10states)
    print(type(last10states))
    """
    return first10abbrs + last10states
